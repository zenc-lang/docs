...
Firstly we create a 'reasonably complete' rational number module, rat.zc, for use in this and other Rosetta Code tasks which require such numbers:
...
Then we import it (preferably from the same directory) into the following program to complete the task:
...
---
**Attribution:** This is a community solution for the Rosetta Code task [**Arithmetic/Rational**](https://rosettacode.org/wiki/Arithmetic/Rational) in Zen C.

*This article uses material from the Rosetta Code article **Arithmetic/Rational**, which is released under the [GNU Free Documentation License 1.3](https://www.gnu.org/licenses/fdl-1.3.html). A list of the original authors can be found in the [page history](https://rosettacode.org/wiki/Arithmetic/Rational?action=history).*
