...
# 12. Продвинутые темы и метапрограммирование {#12-prodvinutye-temy-i-metaprogrammirovanie}
...
[Дополнительная информация о диагностической системе](@/tour/16-diagnostics.ru.md#16-sistema-diagnostiki)
