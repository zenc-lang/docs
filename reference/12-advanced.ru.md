...
Zen C предоставляет категоризированную систему диагностики, которой можно управлять с помощью флагов `-W` и `-Wno-`. Это полезно для управления предупреждениями, связанными с безопасностью, неиспользуемым кодом и переносимостью C.
